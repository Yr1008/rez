...
function Stage({
  ...
  React.useEffect(() => {
    ...
    const measure = () => {
      ...
      // Container not laid out yet (0-size host) — retry until layout is real.
      // Chained setTimeout, NOT rAF/ResizeObserver: those are render-tied and
      // never fire in a hidden/backgrounded iframe; timers always do.
      if (!el.clientWidth || s <= 0.051) {
        if (tries++ < 150) retryTimer = setTimeout(measure, 200);
      }
