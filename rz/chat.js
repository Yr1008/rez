...
(function(){
  ...
  function botReply(q){
    ...
    var live = {label:'Try Kira live', href:'Solutions.dc.html#live-demo'};
  ...
  function boot(){
    ...
    var msgs = [{who:'bot',text:"Hi, I'm Kira, Rezonate's voice agent. Ask me what we do, pick an industry, or see it live.", ctas:[{label:'What is Kira?',ask:'What is Kira?'},{label:'See it live',href:'Solutions.dc.html#live-demo'}]}];
    var botT;
